...
function SignUpForm() {
  ...
  const validateInput = (e)=>{
      ...
      // Email validation
      if (!formData.userEmail || !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(formData.userEmail)) {
        newErrors.userEmail = 'Valid Email is required.';
      }
    
      // Mobile number validation
      if (!formData.mobileNumber || formData.mobileNumber.length < 10 || formData.mobileNumber.length > 15) {
      ...
      if(formData.userPassword != formData.confirmPassword || formData.confirmPassword == "") newErrors.confirmPassword = 'Password does not match'
    ...
    <AnimatePresence>
      {
        ...
        <div style={{display: 'flex', flexDirection: 'column'}}>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              required
            />
            {errors.userName && <span style={{ color: 'red' }}>Full Name is required.</span>}
          </div>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              required
            />
            {errors.userEmail && <span style={{ color: 'red' }}>Valid Email is required.</span>}
          </div>
          ...
          <div className="mb-3">
            ...
            {errors.mobileNumber && <span style={{ color: 'red' }}>Phone number must be between 10 and 15 digits.</span>}
          </div>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              required
            />
            {errors.userPassword && <span style={{ color: 'red' }}>Password is required.</span>}
          </div>
          ...
          <button onClick={validateInput} className="btn btn-primary">Next</button>
        </div>
      </form>
        ...
        <AnimatePresence>
{
  showAssesmentform && <AssesMe setSuccessSubmit={setSuccessSubmit} setFormData={setFormData} setShowAssesmentForm={setShowAssesmentForm} formData = {formData} />
}
        </AnimatePresence>
        <AnimatePresence>
          {
